export function BusinessCard({userData}) {
  return (
    <div style={styles.card}>
      ...
      <p style={styles.description}>{userData.desc}</p>
      ...
      <div style={styles.socialLinks}>
        <a href={userData.linkedin} target="_blank" rel="noopener noreferrer" style={{ ...styles.link, marginLeft: '0px' }}>
          LinkedIn
        </a>
        <br />
        <a href={userData.github} target="_blank" rel="noopener noreferrer" style={styles.link}>
          Twitter
        </a>
        {userData.otherSocialMedia && (
          <a href={userData.otherSocialMedia} target="_blank" rel="noopener noreferrer" style={styles.link}>
            {userData.otherSocialMedia.label}
          </a>
        )}
      </div>
    </div>
